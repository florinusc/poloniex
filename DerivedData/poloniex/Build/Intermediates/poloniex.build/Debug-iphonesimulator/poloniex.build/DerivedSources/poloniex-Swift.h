...
SWIFT_CLASS("_TtC8poloniex11AppDelegate")
...
SWIFT_CLASS("_TtC8poloniex9ChartCell")
...
SWIFT_CLASS("_TtC8poloniex12TickerDetail")
@interface TickerDetail : UIViewController <UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
@property (nonatomic, strong) NSDictionary * _Nonnull coinData;
@property (nonatomic, copy) NSString * _Nonnull coinPair;
...
@interface TickerListVC (SWIFT_EXTENSION(poloniex)) <UISearchResultsUpdating>
- (void)updateSearchResultsForSearchController:(UISearchController * _Nonnull)searchController;
@end

@class UISearchBar;

@interface TickerListVC (SWIFT_EXTENSION(poloniex)) <UISearchBarDelegate, UIBarPositioningDelegate>
